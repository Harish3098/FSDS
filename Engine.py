...
pant_color_dict = {"DISABLED.png": '-1', "fullpant_olive.png": '0', "fullpant_white.png": '1', "fullpant_blue.png": '2',
...
def clicked():
    ...
    os.system(
        "python Main.py " + str(2) + " " + str(1)  + " " + str(-1)  + " " + shirt_size + " " + pant_size)
...
btn = Button(window, text="sss Launch Trial", bg="orange", fg="red", font=("Comic Sans MS", 15), width=25, command=clicked)
btn.grid(column=1, row=10, pady=20)
btn1 = Button(window, text="View Pose Estimation", bg="orange", fg="dark green", font=("Comic Sans MS", 10), width=15,
              command=clicked1)
...
shirt_rad1 = Radiobutton(window, variable=shirtcolor, width=10, indicator=0, background="light blue", text='Disable',
                         value="DISABLED.png", command=changeshirt, justify=LEFT, compound=LEFT,
                         font=("Comic Sans MS", 10))
shirt_rad1.select()
shirt_rad2 = Radiobutton(window, variable=shirtcolor, width=10, indicator=0, background="light blue", text='REDa',
                         value="full_shirt_red.png", command=changeshirt, justify=LEFT, compound=LEFT,
                         font=("Comic Sans MS", 10))

shirt_rad3 = Radiobutton(window, variable=shirtcolor, width=10, indicator=0, background="light blue", text='CREME',
                         value="full_shirt_creme.png", command=changeshirt, justify=LEFT, compound=LEFT,
                         font=("Comic Sans MS", 10))

shirt_rad4 = Radiobutton(window, variable=shirtcolor, width=10, indicator=0, background="light blue", text='YELLOW',
                         value="full_shirt_yellow.png", command=changeshirt, justify=LEFT, compound=LEFT,
                         font=("Comic Sans MS", 10))

shirt_rad5 = Radiobutton(window, variable=shirtcolor, width=10, indicator=0, background="light blue", text='BLUE',
                         value="full_shirt_blue.png", command=changeshirt, justify=LEFT, compound=LEFT,
                         font=("Comic Sans MS", 10))

shirt_rad6 = Radiobutton(window, variable=shirtcolor, width=10, indicator=0, background="light blue", text='PINK',
...
pant_rad1 = Radiobutton(window, variable=pantcolor, width=10, indicator=0, background="light blue", text='Disable',
                        value="DISABLED.png", command=changepant, justify=LEFT, font=("Comic Sans MS", 10))
pant_rad1.select()
pant_rad2 = Radiobutton(window, variable=pantcolor, width=10, indicator=0, background="light blue", text='OLIVE',
                        value="fullpant_olive.png", command=changepant, justify=LEFT, font=("Comic Sans MS", 10))
pant_rad3 = Radiobutton(window, variable=pantcolor, width=10, indicator=0, background="light blue", text='WHITE',
                        value="fullpant_white.png", command=changepant, justify=LEFT, font=("Comic Sans MS", 10))
...
pant_rad5 = Radiobutton(window, variable=pantcolor, width=10, indicator=0, background="light blue", text='GREEN',
                        value="fullpant_green.png", command=changepant, justify=LEFT, font=("Comic Sans MS", 10))
...
pant_rad7 = Radiobutton(window, variable=pantcolor, width=10, indicator=0, background="light blue", text='BROWN',
                        value="fullpant_brown.png", command=changepant, justify=LEFT, font=("Comic Sans MS", 10))
...
glass_rad1 = Radiobutton(window, variable=glasscolor, width=10, indicator=0, background="light blue", text='Disable',
                         value="DISABLED.png", command=changeglass, justify=LEFT, font=("Comic Sans MS", 10))
glass_rad1.select()
glass_rad2 = Radiobutton(window, variable=glasscolor, width=10, indicator=0, background="light blue", text='GREY',
                         value="glasses0.png", command=changeglass, justify=LEFT, font=("Comic Sans MS", 10))
glass_rad3 = Radiobutton(window, variable=glasscolor, width=10, indicator=0, background="light blue", text='GOLD-RIM',
                         value="glasses1.png", command=changeglass, justify=LEFT, font=("Comic Sans MS", 10))
glass_rad4 = Radiobutton(window, variable=glasscolor, width=10, indicator=0, background="light blue", text='RED',
                         value="glasses2.png", command=changeglass, justify=LEFT, font=("Comic Sans MS", 10))
glass_rad5 = Radiobutton(window, variable=glasscolor, width=10, indicator=0, background="light blue", text='THUG-LIFE',
