...
#### (0,0,100) - RED
#### (-40,-20,20) - BROWN
pant_color_dict = {'0': [0, 0, 0], '1': [100, 100, 100], '2': [100, 0, 0], '3': [0, 100, 0], '4': [0, 0, 100],
                   '5': [-40, -20, 20]}
    ...
    if len(upscale_bbox) > 0:
        ...
        if glass_enabled:
            if right_eyeX > 0 and left_eyeX > 0 and right_earX > 0 and left_earX > 0:
                ...
                width = int(
                    Distance((right_earX + right_eyeX) / 2, (right_earY + right_eyeY) / 2, (left_earX + left_eyeX) / 2,
                             (left_earY + left_eyeY) / 2) * size)
